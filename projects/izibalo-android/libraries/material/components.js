	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		$.each(item.listitems, function(i,elm){	
			...
			if(prx.componentsHelper.getProp(elm.itemtype,'other') == 'separator') {
                ...
                if (typeof(elm.thumbnail) == "undefined") {
                    elm.thumbnail = {"fileId": "", "name": "", "assetType": ""}
                }
                if (typeof(elm.leftIcon) == "undefined") {
                    elm.leftIcon = {
                        "fileId": "",
                        "name": "",
                        "assetType": "icon",
                ...
                if (typeof(elm.rightIcon) == "undefined") {
                    elm.rightIcon = {
                        "fileId": "",
                        "name": "",
                        "assetType": "icon",
...
if (typeof(elm.thumbnail) == "undefined") {
            ...
            if (typeof(elm.leftIcon) == "undefined") {
                elm.leftIcon = {"fileId": "", "name": "", "assetType": "icon", "url": ""}
            }
            if (typeof(elm.rightIcon) == "undefined") {
                elm.rightIcon = {"fileId": "", "name": "", "assetType": "icon", "url": ""}
            }
