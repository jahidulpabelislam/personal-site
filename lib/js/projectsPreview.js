...
var renderProjectsPreviewError = function(error) {
    ...
    renderProjectPreview = function(project) {
        var slidesContainer = document.querySelector(".slidesContainer"),
            ...
            slide = createElement(slideContainer, "div", {class: "slide" + project.ID}),

            projectDescriptionContainer = createElement(slide, "div", {class: "projectDescriptionContainer"}),
            ...
            bullet = createElement(bulletContainer, "label", {class: "slide" + project.ID}),
