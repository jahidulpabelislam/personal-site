...
var renderProjectsPreviewError = function(error) {
    ...
    renderProjectPreview = function(project) {
        var slidesContainer = document.querySelector(".slidesContainer"),
            ...
            projectName = createElement(projectHeader, "h3", {innerHTML: project.Name, className: "article__header projectTitle"}),
        ...
        if (project.Link) {
            createElement(projectLinks, "a", {
                href: project.Link,
                innerHTML: "View",
                className: "btn btn--clear projectPreLink",
                target: "_blank"
            });
        }
        ...
        createElement(projectLinks, "a", {
            href: project.GitHub,
            innerHTML: "GitHub",
            className: "btn btn--clear projectPreGitHub",
            target: "_blank"
        });
