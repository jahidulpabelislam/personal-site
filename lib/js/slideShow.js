...
var autoSlide = {},
    ...
    moveToSlide = function(id, nextSlide) {
        ...
        if (id == "projectPreview"){
            var colour = nextSlide.filter(".slideContainer").attr("data-slide-colour");
            var regx = new RegExp("slideShowNav--\\w*", 'g');

            $("#" + id + " .slideShowNav").each(function() {
                var classList = $(this).attr("class");
                classList =  classList.replace(regx, 'slideShowNav--'+colour);
                $(this).attr("class", classList);
            });

            $("#" +id + " .slideShowViewpoint").height(nextSlide.children().filter(".slide").height());
        }
    ...
    setUpSlideShow = function(id) {
        ...
        if (id == "projectPreview"){
            $("#" +id + " .slideShowViewpoint").height(slideContainer.first().children().filter(".slide").height());
        }
    };
