...
var autoSlide = {},
    ...
    touchStart = function(e, id) {
        ...
        var start = e.changedTouches ? e.changedTouches[0].clientX : e.clientX,
            ...
            touchEnd = function(e) {
                ...
                $("#" + id + " .slideShowViewpoint")[0].removeEventListener("touchmove", touchMove);
                $("#" + id + " .slideShowViewpoint")[0].removeEventListener("touchend", touchEnd);
                $("#" + id + " .slideShowViewpoint")[0].removeEventListener("mousemove", touchMove);
                $("#" + id + " .slideShowViewpoint")[0].removeEventListener("mouseup", touchEnd);
                $("#" + id + " .slideShowViewpoint")[0].removeEventListener("mouseleave", touchCancel);
            },
        ...
        $("#" + id + " .slideShowViewpoint")[0].addEventListener("touchmove", touchMove);
        $("#" + id + " .slideShowViewpoint")[0].addEventListener("touchend", touchEnd);
        $("#" + id + " .slideShowViewpoint")[0].addEventListener("mousemove", touchMove);
        $("#" + id + " .slideShowViewpoint")[0].addEventListener("mouseup", touchEnd);
        $("#" + id + " .slideShowViewpoint")[0].addEventListener("mouseleave", touchCancel);
    },
    ...
    setUpSlideShow = function(id) {
        ...
        if ($("#" + id + " .slideContainer").length > 1) {
            ...
            slideShowViewpoint[0].addEventListener("mousedown", function(e) {
                touchStart(e, id);
            });

            slideShowViewpoint[0].addEventListener("touchstart", function(e) {
                touchStart(e, id);
            });
