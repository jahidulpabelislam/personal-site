    ...
    addProjectPictures = function(project, slidesContainer, slideShowBullets, projectsElementName) {
        ...
        for (var i = 0; i < project.pictures.length; i++) {
            ...
            if (project.pictures.hasOwnProperty(i)) {
                ...
                var slideContainer = createElement(slidesContainer, "div", {class: "slideContainer"}),

                    slide = createElement(slideContainer, "div", {class: "slide" + project.pictures[i].ID}),
                    ...
                    bulletContainer = createElement(slideShowBullets, "div", {class: "bullet"}),

                    bullet = createElement(bulletContainer, "label", {class: "slide" + project.pictures[i].ID});
