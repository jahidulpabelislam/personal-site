...
var url = new URL(window.location),
    ...
    addProjectPictures = function(project, slidesContainer, slideShowBullets, slideShowId) {
        ...
        for (var i = 0; i < project.pictures.length; i++) {
            ...
            if (project.pictures.hasOwnProperty(i)) {
                ...
                var slideContainer = createElement(slidesContainer, "div", {class: "slideContainer", id: "slide" + project.pictures[i].ID}),
                    ...
                    img = createElement(slideContainer, "img", {
                ...
                createElement(slideShowBullets, "label", {class: "bullet", "data-slide-show-id": slideShowId, "data-slide-id": "slide"+project.pictures[i].ID});
            }
        }
    ...
    renderProject = function(project) {
        ...
        if (!document.getElementById("project" + project.ProjectID)) {
            ...
            var article = createElement($("#projects")[0], "div", {
                ...
                title = createElement(article, "h3", {
                    innerHTML: project.Name,
                    class: "article__header projectTitle"
                }),

                date = createElement(article, "h4", {
                    innerHTML: project.Date,
                    class: "projectDate"
                }),

                skillsContainer = createElement(article, "div", {class: "skills"}),
                ...
                viewMoreButton = createElement(article, "button", {
                    innerHTML: "Read More »",
                    class: "btn btn--blue viewMoreButton"
                }),

                linksp = createElement(article, "p", {class: "project__links"}),
                ...
                slideShowViewpoint = createElement(slideShow, "div", {class: "slideShowViewpoint", "data-slide-show-id": "slideShow" + project.ID}),

                slidesContainer = createElement(slideShowViewpoint, "div", {class: "slidesContainer"}),

                previous = createElement(slideShowViewpoint, "img", {
                    class: "slideShowNav previous moveSlide",
                    src: "/images/previous.svg",
                    alt: "Click to View Previous Image",
                    "data-slide-show-id": "slideShow" + project.ID,
                    "data-nav-direction": "previous"
                }),

                next = createElement(slideShowViewpoint, "img", {
                    class: "slideShowNav next moveSlide",
                    src: "/images/next.svg",
                ...
                slideShowBullets = createElement(slideShow, "div", {class: "slideShowBullets"});

            addSkills(project.Skills.split(","), skillsContainer);

            addLinks(project, linksp);

            addProjectPictures(project, slidesContainer, slideShowBullets, "slideShow" + project.ID);
            ...
            viewMoreButton.addEventListener("click", function() {
                ...
                addProjectPictures(project, $("#projectsDetail .slidesContainer")[0], $("#projectsDetail .slideShowBullets")[0], "projectsDetailSlideShow");
            });
        }
