...
var url = new URL(window.location),
    ...
    renderError = function(error) {
        ...
        $("#projectsLoading, .pagination").text("").hide("fast");
        delayExpand();
    },
    ...
    setUp = function() {
        if ($(".projects").length > 0)
        {
            ...
            $(".projects").on("click", ".viewMoreButton", function() {
                ...
                $("#projectsDetail .project__links, #projectsDetail .skills, #projectsDetail .slide-show__slides-container, #projectsDetail .slideShowBullets").text("");

                $("#projectsDetail .project-title").text(project.Name);
                $("#projectsDetail .project-date").text(project.Date);
                ...
                $("#projectsDetail .slide-show__nav").each(function() {
...
$("#projectsDetail").click(function(event) {
     if(!$(event.target).closest('.modal__content').length && $("#projectsDetail").hasClass("open")) {
        ...
        document.body.style.overflow = "auto";
         $("#projectsDetailSlideShow .slide-show__viewpoint")[0].removeEventListener("mousedown", dragStart);
         $("#projectsDetailSlideShow .slide-show__viewpoint")[0].removeEventListener("touchstart", dragStart);
         $("#projectsDetailSlideShow .slide-show__slides-container").css("left", "0px");
