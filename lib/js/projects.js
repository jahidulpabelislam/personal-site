    ...
    renderProject = function(project) {
        ...
        if (!document.getElementById("project" + project.ProjectID)) {
            ...
            for (i = 0; i < project.pictures.length; i++) {
                ...
                if (project.pictures.hasOwnProperty(i)) {
                    ...
                    bullet.addEventListener("click", function() {
                        changeToSlide("project" + project.ID, this.className);
                    });
            ...
            viewMoreButton.addEventListener("click", function() {
                ...
                $("#projectsDetail .links, #projectsDetail .skills").text("");
                ...
                for (i = 0; i < skills.length; i++) {
                    if (skills[i].trim() !== "") {
                        ...
                        var skill = createElement($("#projectsDetail .skills")[0], "p", {innerHTML: skills[i]});
                        searches = $("#searchInput")[0].value.split(" ");
                ...
                if (project.Link) {
                    ...
                    createElement($("#projectsDetail .links")[0], "a", {
                        href: project.Link,
                        title: "Link to " + project.Name + " Site",
                        target: "_blank",
                        innerHTML: "View"
                    ...
                    $("#projectsDetail .links")[0].innerHTML += " | ";
                }
                ...
                for (i = 0; i < project.pictures.length; i++) {
                    ...
                    if (project.pictures.hasOwnProperty(i)) {
                        ...
                        var slideContainer = createElement($("#projectsDetail .slidesContainer")[0], "div", {className: "slideContainer"}),
                            ...
                            bulletContainer = createElement($("#projectsDetail .slideShowBullets")[0], "div", {className: "bullet"}),

                            bullet = createElement(bulletContainer, "label", {className: "slide" + project.pictures[i].ID});

                        bullet.addEventListener("click", function() {
                            changeToSlide("projectsDetail", this.className);
                        });
