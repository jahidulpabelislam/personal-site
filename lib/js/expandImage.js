...
var currentSlide = 0,
    ...
    expandImageSetUp = function(e) {
        ...
        for (i = 0; i < slides.length; i++) {
            ...
            var bullet = createElement($("#slideShowBullets")[0], "label", {class: "bullet js-expanded-image-bullet", "data-slide-id": i});
        }
        ...
        $("#expandedImageNext, #expandedImagePrevious").off();
...
$(document).on("ready", function() {
    ...
    $("body").on("click", ".js-expanded-image-bullet", function(e) {
        $("#slideShowBullets .bullet:eq(" + currentSlide + ")").removeClass("active");
        currentSlide = parseInt($(e.target).data("slideId"));
        changeElement();
    });
});