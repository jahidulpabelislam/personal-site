    ...
    var errors = document.getElementById("errors"),
        ...
        gotProjectImages = function (result) {
            ...
            if (dataValid && result.rows[0].ProjectID) {
                var slideShowViewpointContainer = document.getElementById("project" + result.rows[0].ProjectID).querySelector(".slideShowViewpointContainer");
        ...
        getProjectImages = function (id) {
            window.portfolio.xhr.sendRequests({method: "GET", url: "/admin/api/1/pictures/" + id, load: gotProjectImages});
        },
        ...
        renderProject = function (project) {
            ...
            var article = window.portfolio.helperFunctions.createElement(projects, "div", {id: "project" + project.ID, className: "article project"}),
                ...
                slideShow = window.portfolio.helperFunctions.createElement(article, "div", {className: "slideShow"}),
        ...
        gotProjects = function (result) {
            //send the data, the function to do if data is valid
            window.portfolio.xhr.loopThroughData(result, renderProject, renderError, "Error Getting the Projects.");
