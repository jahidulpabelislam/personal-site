...
window.portfolio.projectsPreview = (function () {
    ...
    var errors = document.getElementById("errors"),
        ...
        renderProject = function (project) {
            ...
            if (project.Link) {
                window.portfolio.helperFunctions.createElement(projectLinks, "a", {href: project.Link, innerHTML: "View", className: "btn btn-danger projectPreLink", target: "_blank"});
            }

            window.portfolio.helperFunctions.createElement(projectLinks, "a", {href: project.GitHub, innerHTML: "GitHub", className: "btn btn-warning projectPreGitHub", target: "_blank"});
